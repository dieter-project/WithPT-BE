...
public class BookmarkController {
    ...
    @PostMapping
    public void saveBookmark(@Valid @RequestBody BookmarkRequest request, @AuthenticationPrincipal Long memberId) {
    ...
    @DeleteMapping
    public void deleteExercise(@RequestParam String bookmarkIds, @AuthenticationPrincipal Long memberId) {
