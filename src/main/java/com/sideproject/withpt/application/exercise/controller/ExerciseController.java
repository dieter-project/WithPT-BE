...
public class ExerciseController {
    ...
    @GetMapping
    public ApiSuccessResponse<ExerciseListResponse> findAllExerciseList(@RequestParam String dateTime, @Parameter(hidden = true) @AuthenticationPrincipal Long memberId) {
    ...
    public ApiSuccessResponse<ExerciseResponse> findOneExercise(@PathVariable Long exerciseId, @Parameter(hidden = true) @AuthenticationPrincipal Long memberId) {
    ...
    @GetMapping("/check")
    public ApiSuccessResponse<BookmarkCheckResponse> checkBookmark(@RequestParam String title, @Parameter(hidden = true) @AuthenticationPrincipal Long memberId) {
